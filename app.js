...
async function repairBuenCaminoBoot(force=false){
 ...
 try{sessionStorage.setItem('bc-boot-repaired-v84','1')}catch{}
 const u=new URL('./',location.href);u.searchParams.set('bcv','84');u.searchParams.set('repair',Date.now().toString());location.replace(u.href);
}
