...
function openAboutPrivacy(){
 ...
 <div class="privacy-card"><strong>🎯 Ubicación GPS</strong><p>La ubicación se solicita únicamente cuando pulsas una función GPS. BUEN CAMINO la usa en ese momento para situarte en el mapa y no la guarda en el historial de la app. Al cargar mapas u otros servicios externos, tu navegador se conecta a sus proveedores según sus propias políticas.</p></div>
 <div class="privacy-card"><strong>🌐 Servicios externos</strong><p>Mapas, meteorología, rutas, servicios, fotos y enlaces pueden contactar con proveedores como OpenStreetMap/OpenTopoMap, Open-Meteo, AEMET, Open Pilgrimages, Overpass, Wikimedia Commons, Google Earth/Maps o Wikiloc. Estos servicios pueden recibir información técnica habitual de una conexión web, como la dirección IP.</p></div>
